...
class encoderNetwork(tf.keras.models.Model):
    def __init__(self, n_input1, n_input2, n_hidden1, activation):
        super(encoderNetwork, self).__init__()
        # super().__init__(*args, **kwargs)
        self.l3 = None
        self.ensmallNetwork = inputSmallNetwork(n_input1, n_input2, activation)
        self.n_hidden3 = n_hidden1
...
class Autoencoder(tf.keras.models.Model):
    def __init__(self, n_input1, n_input2, n_hidden1, n_hidden2, activation):
        ...
        self.encoder = encoderNetwork(n_input1, n_input2, n_hidden1, activation)
    ...
    def train(self,inputs):
        ...
        plt.savefig(r'C:\Users\gklizh\Documents\Workspace\code_and_data12\figure\loss_curve\training_picture' + f'_testB.png')
        plt.close()
