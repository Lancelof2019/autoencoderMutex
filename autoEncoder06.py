...
#################################################################################################
    def cross_validation(self, params, inputs):
        ...
        cost_val = self.lossfun([inputs[0], inputs[1]], False)
        #costfinal = tf.reduce_mean(self.lossfun(train_input1, train_input2))
        #score_profile = self.H
    ...
    def train_test(self, params, testInput, sae):
        ...
        plt.savefig(r'C:\Users\gklizh\Documents\Workspace\code_and_data12\figure\loss_curve\train_test_picture_results' + str(self.iterator) + '_test32.png')
        plt.close()
        return best_cost
...
def partialProcess(iterator, selected_features, inputhtseq, inputmethy,act):
    ...
    fname = r'C:\Users\gklizh\Documents\Workspace\code_and_data12\data\python_related\result\comm_trials_binary_test32_'+str(iterator)+'.pkl'
    ...
    if htseq_nbr > 1 and methy_nbr > 1:
        ...
        cmt_scores = sae.H#
        cmt_scores_numpy = cmt_scores.numpy()
        with open(
                r'C:\Users\gklizh\Documents\Workspace\code_and_data12\data\python_related\result\community\communityScores_compare_32_'+str(iterator)+'.csv',
                'w',newline='') as csvfile:
            writer = csv.writer(csvfile)
            [writer.writerow(r) for r in cmt_scores_numpy]
        ...
        f = open(
            r'C:\Users\gklizh\Documents\Workspace\code_and_data12\data\python_related\result\comm_parameter_binary32_'+str(iterator)+'.txt',
            'a+')
...
def parallel_processing(selected_features, inputhtseq, inputmethy, num_processes,act):
    ...
    with multiprocessing.Pool(processes=num_processes) as pool:
        ...
        pool.map(process_iteration, range(21))#join and close
...
if __name__ == '__main__':
    ...
    #fname = r'C:\Users\gklizh\Documents\Workspace\code_and_data12\data\python_related\result\comm_trials_binary_test29.pkl'
    #with open(fname, 'wb+') as fpkl:
        #pass
