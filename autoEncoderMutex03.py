...
#################################################################################################
    ...
    def train_test(self, params, testInput,sae):
        ...
        plt.savefig(r'C:\Users\gklizh\Documents\Workspace\code_and_data12\figure\loss_curve\train_test_picture_results' + str(iterator) + '_test26.png')
        plt.close()
        return best_cost
...
if __name__ == '__main__':
    ...
    for iterator in range(21):
        ...
        if htseq_nbr > 1 and methy_nbr > 1:
            ...
            #f = open(
             #   r'C:\Users\gklizh\Documents\Workspace\code_and_data12\data\python_related\result\comm_parameter_binary25.txt',
             #   'a+')
           ...
           # f.close()
            ...
            # save the best HPs
            #fname = './result/comm_trials_binary.pkl'
           # pickle.dump(trials, open(fname, "ab"))
            ...
            #f = open('./result/comm_parameter_binary.txt', 'a+')
            #for k, v in best.items():
            #    f.write(str(k) + ':' + str(v) + ',')
            #f.write(str(loss))
            # f.write('\n')
