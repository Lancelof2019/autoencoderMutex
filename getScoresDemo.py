...
class Autoencoder(tf.keras.models.Model):
    ...
    def train(self, inputs,iterator):
        ...
        plt.savefig(r'C:\Users\gklizh\Documents\Workspace\code_and_data12\figure\loss_curve\getscores_picture' + str(iterator) + '_test26_2.png')
        plt.close()
...
def partialProcess(iterator, selected_features, inputhtseq, inputmethy, act):
    trials = {}
    cmt_scores = None
    fname = r'C:\Users\gklizh\Documents\Workspace\code_and_data12\data\python_related\result\comm_trials_binary_test26_' + str(
        iterator) + '.pkl'
    ...
    if htseq_nbr > 1 and methy_nbr > 1:
        ...
        # pickle.dump(shapfeat, open(fname, "wb"))
            with open(
                r'C:\Users\gklizh\Documents\Workspace\code_and_data12\data\python_related\result\community\communityScores_compare26_2_'+str(iterator)+'.csv',
